...
<section data-markdown>
  <textarea data-template>
	    "First thing to do:
        CREATE a book  where you can add all your content including pages, media, and relationships.
        To create a book, first navigate to your Dashboard by clicking the wrench icon.
	</textarea>
</section>
